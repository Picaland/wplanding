...
<div class="wpl-doc-wrapper">
    ...
    <?php if (! \WpLanding\AcfController::disable('service')) : ?>
        <!-- service  -->
    ...
    <?php if (! \WpLanding\AcfController::disable('center_page')) : ?>
        <!-- intro  -->
    ...
    <?php if (! \WpLanding\AcfController::disable('benefits')) : ?>
        <!-- benefits  -->
                    ...
                    <div class="wpl-benefits-cta">
                        <a class="btn wpl-button wpl-button-fill"
                           href="<?php echo esc_url(\WpLanding\AcfController::benefitsCtaUrl()); ?>">
                            <?php echo \WpLanding\AcfController::benefitsCtaText(); ?> <i
    ...
    <?php if (! \WpLanding\AcfController::disable('testimonials')) : ?>
        <?php
        // Scoped style
    ...
    <?php if (! \WpLanding\AcfController::disable('footer')) : ?>
        <?php
        // Scoped style
    ...
    <footer id="wpl_footer" class="wpl-footer">
        ...
        <?php if (! \WpLanding\AcfController::disable('colophon')) : ?>
